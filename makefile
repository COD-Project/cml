...
c.o:
	gcc $(TEST_FOLDER)/main.c $(SOURCE_FOLDER)/cml.c $(MATH_FOLDER)/oop/Field.c $(MATH_FOLDER)/oop/Real.c $(MATH_FOLDER)/oop/Rational.c $(MATH_FOLDER)/oop/Complex.c $(MATH_FOLDER)/functions.c $(MATH_FOLDER)/real_usefull_functions.c $(MATH_FOLDER)/real_general_functions.c $(MATH_FOLDER)/real_euclidean_trigonometry.c $(MATH_FOLDER)/real_non_euclidean_trigonometry.c $(MATH_FOLDER)/real_euclidean_geometry.c $(MATH_FOLDER)/real_non_euclidean_geometry.c $(MATH_FOLDER)/calculus.c $(MATH_FOLDER)/complex_usefull_functions.c $(MATH_FOLDER)/complex_general_functions.c $(MATH_FOLDER)/complex_euclidean_trigonometry.c $(MATH_FOLDER)/complex_non_euclidean_trigonometry.c $(MATH_FOLDER)/complex_euclidean_geometry.c $(MATH_FOLDER)/complex_non_euclidean_geometry.c -o $(BUILD_FOLDER)/$(TEST_OUTPUT_NAME) $(CFLAGS) $(DEBUG)
